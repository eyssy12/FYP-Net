    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GcmMobileClient", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerPerson", x => new { x.PersonId, x.LecturerId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EnrollmentStage = table.Column<int>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    SemesterId = table.Column<int>(nullable: true),
                    YearCommenced = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Module_Semester_SemesterId",
                        column: x => x.SemesterId,
                        principalTable: "Semester",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BackgroundColorDescriptive = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LecturerModule", x => new { x.LecturerId, x.ModuleId });
                    table.ForeignKey(
                        name: "FK_LecturerModule_Lecturer_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentPerson", x => new { x.PersonId, x.StudentId });
                    table.ForeignKey(
        ...
        {
            migrationBuilder.DropTable("GcmMobileClient");
            migrationBuilder.DropTable("LecturerModule");
            migrationBuilder.DropTable("LecturerPerson");
            migrationBuilder.DropTable("StudentModule");
            migrationBuilder.DropTable("StudentPerson");
